...
curl -X PUT http://$PUBSUB_SETUP_HOST/v1/projects/project/subscriptions/rm-internal-sms-fulfilemnt_case-processor -H 'Content-Type: application/json' -d '{"topic": "projects/project/topics/rm-internal-sms-fulfilment"}'
